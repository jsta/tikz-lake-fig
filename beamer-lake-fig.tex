...
\begin{tikzpicture}[scale = #1]
  \draw [-,ultra thick, #2!40] (1,0) to [out=0,in=180] (2.25,0);
  \draw [-,ultra thick, dashed, #2!40] (6,0) to [out=0,in=180] (7.25,0);
...
\begin{tikzpicture}[scale = #1]
  \draw [-,ultra thick, #2!40] (2,0) to [out=0,in=180] (3.25,0);
...
\begin{tikzpicture}[scale = #1]
  \draw [-,ultra thick, #2!40] (-2,0) to [out=0,in=180] (-3.25,0);
  \draw [-,ultra thick, dashed, #2!40] (2,0) to [out=0,in=180] (3.25,0);
