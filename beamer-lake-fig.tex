...
\begin{tikzpicture}[scale = #1]
  \draw [fill=#2!100, ultra thick] (0.1,-.3) rectangle (1.7,0.1);
  \draw [fill=#2!100, ultra thick] (5.3,0.1) rectangle (6.2,-0.3);
  % \node at (2, 1) {Secondary};
\draw
  [fill=#2,
  ultra thick,
...
\begin{tikzpicture}[scale = #1]
  \draw [fill=#2!100, ultra thick] (1.8,-.3) rectangle (3.2,0.1);
  \draw [fill=#2!100, ultra thick] (-1.8,0.1) rectangle (-3.2,-0.3);
  % \node at (2, 1) {Secondary};
\draw
  [fill=#2,
  ultra thick
