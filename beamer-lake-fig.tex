...
\begin{tikzpicture}[scale = #1]
  \draw [-,line width = 5, #2!40] (0.9,0) to [out=0,in=180] (1.55,0);
  \draw [-,line width = 5, dashed, #2!40] (5.5,0) to [out=0,in=180] (6.2,0);
...
\begin{tikzpicture}[scale = #1]
  \draw [-,line width = 5, #2!40] (1.95,0) to [out=0,in=180] (2.7,0);
...
\begin{tikzpicture}[scale = #1]
  \draw [-,line width = 5, #2!40] (-2,0) to [out=0,in=180] (-2.7,0);
  \draw [-,line width = 5, dashed, #2!40] (2,0) to [out=0,in=180] (2.7,0);
