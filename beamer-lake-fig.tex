...
\begin{columns}
  ...
  \begin{column}{0.7\textwidth}
    \begin{tikzpicture}[scale = #1]
      ...
      $IWS$};
      \draw [cyan, thick, decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
      (4.3,-1.5) -- (4.3,9) node [cyan,midway,xshift=0.9cm] {\footnotesize
      $NWS$};
      \draw [darkgreen, thick, decorate, decoration={brace,amplitude=10pt,raise=4pt},yshift=0pt]
      (-2.5,2.9) -- (-2.5,6.1) node [darkgreen,midway,xshift=-0.9cm, align=left] {\footnotesize
      $IWS$};
      \draw [darkgreen, thick, decorate, decoration={brace,amplitude=10pt,raise=4pt},yshift=0pt]
      (-3.8,2.9) -- (-3.8,9) node [darkgreen,midway,xshift=-0.9cm, align=left] {\footnotesize
      $NWS$};
    \end{tikzpicture}
  \end{column}  
\end{columns}
