...
\begin{columns}
  ...
  \begin{column}{0.7\textwidth}
    \begin{tikzpicture}[scale = #1]
      ...
      \draw[yellow, ultra thick, domain=0:350, smooth cycle, yshift=7cm, fill=yellow] (0,-3) plot (\x:0.9+rnd*0.5);
      \node at (0, 7) {Lake 1};
      ...
      \draw [cyan, thick, decorate, decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
      (3,-1.5) -- (3,6.1) node [cyan,midway,xshift=0.9cm] {\footnotesize
      $IWS$};
      \draw [cyan, thick, decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
      (4.3,-1.5) -- (4.3,9.1) node [cyan,midway,xshift=0.9cm] {\footnotesize
      $NWS$};
      \draw [darkgreen, thick, decorate, decoration={brace,amplitude=10pt,raise=4pt},yshift=0pt]
      (-2.5,2.5) -- (-2.5,6.1) node [darkgreen,midway,xshift=-0.9cm, align=left] {\footnotesize
      $IWS$};
\draw [darkgreen, thick, decorate, decoration={brace,amplitude=10pt,raise=4pt},yshift=0pt]
      (-3.8,2.5) -- (-3.8,9) node [darkgreen,midway,xshift=-0.9cm, align=left] {\footnotesize
      $NWS$};
    \end{tikzpicture}
  \end{column}  
\end{columns}
